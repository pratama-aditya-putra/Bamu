    ...
    <div class="container fg-white h-100">
      <div class="row align-items-center h-100 d-flex justify-content-center">
        <div class="col-lg-6 wow fadeInUp" style="margin-bottom: 6%;text-align:center;">
          ...
          <p class="mb-4 ml-3">Login to Continue Learn & Practice HTML</p>
            <div style="width: 78%;height: 400px; border: solid; border-radius: 20px; border-color: white; margin-left:10%;">
                <div class="d-flex justify-content-center align-items-stretch p-2" style="height: 80px;">
                  <div class="p-2 flex-fill" style="border-right : solid;border-color: white; width:100%;">
                      <button class="button1" style="width: 95%;height: 50px; border-top-left-radius: 10px; margin-left:3%;" onclick="window.location.href='login.php'">Login</button></div>
                  <div class="p-2 flex-fill" style="border-left: solid; border-color: white; width:100%;">
                      <button class="button2" style="width: 95%;height: 50px; border-top-right-radius: 10px; margin-left:3%;" onclick="window.location.href='signup.php'">Sign Up</button></div>
                </div>
                <div>
                    <form class="form" style="margin-left: 30px; margin-right: 30px;" action="aksi_signup.php" method="post">
                        <div   style="margin-bottom: 20px;"></div>
                      <label class="sr-only" for="FormInputGroupUsername2">Full name</label>
                      <div class="input-group mb-2 mr-sm-2">
                        <div class="input-group-prepend">
                          <div class="input-group-text"><img src="../assets/img/icon1.png" style="width: 20px; height: 20px;"> </div>
                        </div>
                        <input type="text" name="fName" class="form-control" id="FormInputGroupUsername2" placeholder="Full name">
                      </div>
                        <div   style="margin-bottom: 20px;"></div>
                      ...
                      <div class="input-group mb-2 mr-sm-2"  style="margin-bottom: 30px;">
                        ...
                        <input type="text" name="username" class="form-control" id="FormInputGroupUsername2" placeholder="Username">
                      </div>
                        <div   style="margin-bottom: 20px;"></div>
                        <label class="sr-only" for="FormInputGroupUsername2">Password</label>
                      <div class="input-group mb-2 mr-sm-2"  style="margin-bottom: 100px;">
                        <div class="input-group-prepend">
                          <div class="input-group-text"><img src="../assets/img/icon3.png" style="width: 20px; height: 20px;"></div>
                        </div>
                        <input type="text" name="password" class="form-control" id="FormInputGroupUsername2" placeholder="Password">
                      </div>
                        <div   style="margin-bottom: 40px;"></div>
                                <button class="btn3 float-right rounded-pill" style="width: 100px; height: 50px;">Sign Up</button>
