  ...
  <style>
    ...
    if($xxx == 1){
        ...
        if(isset($_POST['SubmitAns'])){
            $input = $_POST['ex1'];
            if(($input == "\$_GET[\"fname\"]")||($input == "\$_GET[\'fname\']")){
                $output1 = "update score set soal11=1 where IDuser = '$username';";
        ...
        <div class="col-lg-6 wow fadeInUp" style="margin-bottom: 0px;">
            <form autocomplete="off" id="w3-exerciseform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="bg-dark" style="width:750px;; padding:10px;  border-radius:10px;">
                ...
                <div class="exercisewindow" style="background-color:white; color:black; padding:10px;">
                    ...
                    <pre><div style="background-color:white; padding:10px">&lt;form action="welcome.php" method="get"&gt;
                    First name: &lt;input type="text" name="fname"&gt;
                    &lt;/form&gt;
                    </div>
                    &lt;html&gt;
                    &lt;body&gt;
                    Welcome &lt;?php echo <input name="ex1" maxlength="14" style="width: 148px;"  id="text-box1" value="<?php echo $input; ?>" <?php if($xxx == 1) echo 'disabled' ?>>; ?&gt;
                    &lt;/body&gt;
                    &lt;/html&gt;
                    </pre>
                    </div>
            ...
            <div class="d-flex justify-content-between" style="width:750px; margin-top:50px;">
                <button class=" btn btn-dark"type="button" onclick="window.location.href='10.php'" style="width:120px;">« Before</button>
                <button class=" btn btn-dark"type="button" onclick="window.location.href='12.php'" style="width:120px;">Next »</button>
            </div>
      </div>
    </div>
  </div>
