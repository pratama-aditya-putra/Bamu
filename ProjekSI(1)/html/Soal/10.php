  ...
  <style>
    ...
    if($xxx == 1){
        ...
        if(isset($_POST['SubmitAns'])){
            $input1 = $_POST['ex1'];
            $input2 = $_POST['ex2'];
            if(($input1 == "\$txt")&&($input2 == "Hello")){
                $output1 = "update score set soal10=1 where IDuser = '$username';";
        ...
        <div class="col-lg-6 wow fadeInUp" style="margin-bottom: 0px;">
            <form autocomplete="off" id="w3-exerciseform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="bg-dark" style="width:750px;; padding:10px;  border-radius:10px;">
                ...
                <div class="exercisewindow" style="background-color:white; color:black; padding:10px;">
                    <h2>Variable Exercise:</h2>
                    <p>Create a variable named <code class="w3-codespan">txt</code> and assign the value <code class="w3-codespan">"Hello"</code>.</p>
                    <div class="exerciseprecontainer">
                    <pre><input name="ex1" maxlength="4" style="width: 43px;" id="text-box1" value="<?php echo $input1; ?>" <?php if($xxx == 1) echo 'disabled' ?>> = "<input name="ex2" maxlength="5" style="width: 54px;"  id="text-box1" value="<?php echo $input2; ?>" <?php if($xxx == 1) echo 'disabled' ?>>";
                    </pre>
                    </div>
                    <br>
            ...
            <div class="d-flex justify-content-between" style="width:750px; margin-top:50px;">
                <button class=" btn btn-dark"type="button" onclick="window.location.href='9.php'" style="width:120px;">« Before</button>
                <button class=" btn btn-dark"type="button" onclick="window.location.href='11.php'" style="width:120px;">Next »</button>
            </div>
      </div>
    </div>
  </div>
