  ...
  <style>
    ...
    if($xxx == 1){
        ...
        if(isset($_POST['SubmitAns'])){
            $input = $_POST['ex1'];
            if($input == "<h1>London</h1>"){
                $output1 = "update score set soal2=1 where IDuser = '$username';";
...
<div class="d-flex justify-content-center" style="padding:5%;">
    ...
    <div class="row align-items-center h-100" style="margin-top:10%;">
        <div class="col-lg-6 wow fadeInUp" style="margin-bottom: 0px; margin-top">
            <form autocomplete="off" id="w3-exerciseform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="bg-dark" style="width:750px;; padding:10px;  border-radius:10px;">
                ...
                <div class="exercisewindow" style="background-color:white; color:black; padding:10px;">
                        <h2>Header Exercise:</h2>
                        <p>Use the correct HTML tag to add a heading with the text "London".(use the biggest header size)</p>
                        <div class="exerciseprecontainer">
                        <input class="float-center" name="ex1" maxlength="15" style="width: 155px;"  id="text-box1" value="<?php echo $input; ?>"
            ...
            <div class="d-flex justify-content-between" style="width:750px; margin-top:50px;">
                <button class=" btn btn-dark"type="button" onclick="window.location.href='1.php'" style="width:120px;">« Before</button>
                <button class=" btn btn-dark"type="button" onclick="window.location.href='3.php'" style="width:120px;">Next »</button>
            </div>
      </div>
    </div>
  </div>
