  ...
  <style>
    ...
    if($xxx == 1){
        ...
        if(isset($_POST['SubmitAns'])){
            ...
            $input3 = $_POST['ex3'];
            $input4 = $_POST['ex4'];
            if(($input1 == ".special")&&($input2 == "{")&&($input3 == "color:blue")&&($input4 == "}")){
                $output1 = "update score set soal7=1 where IDuser = '$username';";
        ...
        <div class="col-lg-6 wow fadeInUp" style="margin-bottom: 0px;">
            <form autocomplete="off" id="w3-exerciseform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="bg-dark" style="width:750px;; padding:10px;  border-radius:10px;">
                ...
                <div class="exercisewindow" style="background-color:white; color:black; padding:10px;">
                    <h2>Selector Exercise:</h2>
                    <p>Create a class selector named "special".</p>
                    <p>Add a color property with the value "blue" inside the "special" class.</p>
                    ...
                    &lt;style&gt;
                    <br>
                    <input name="ex1" spellcheck="false" maxlength="8" style="width: 86px;" id="text-box1" value="<?php echo $input1; ?>" <?php if($xxx == 1) echo 'disabled' ?>> <input name="ex2" spellcheck="false" maxlength="1" style="width: 16px;"  id="text-box1" value="<?php echo $input2; ?>" <?php if($xxx == 1) echo 'disabled' ?>>
                    <br>
                    &nbsp;&nbsp;<input name="ex3" spellcheck="false" maxlength="10" style="width: 106px;" id="text-box1" value="<?php echo $input3; ?>" <?php if($xxx == 1) echo 'disabled' ?>>;
                    <br>
                    <input name="ex4" spellcheck="false" maxlength="1" style="width: 16px;" id="text-box1" value="<?php echo $input4; ?>" <?php if($xxx == 1) echo 'disabled' ?>>
                    <br>
                    &lt;/style&gt;
                    <br>
                    &lt;/head&gt;
            ...
            <div class="d-flex justify-content-between" style="width:750px; margin-top:50px;">
                <button class=" btn btn-dark"type="button" onclick="window.location.href='6.php'" style="width:120px;">« Before</button>
                <button class=" btn btn-dark"type="button" onclick="window.location.href='8.php'" style="width:120px;">Next »</button>
            </div>
      </div>
    </div>
  </div>
