  ...
  <style>
    ...
    if($xxx == 1){
        ...
        if(isset($_POST['SubmitAns'])){
            $input = $_POST['ex1'];
            if($input == "echo "){
                $output1 = "update score set soal9=1 where IDuser = '$username';";
        ...
        <div class="col-lg-6 wow fadeInUp" style="margin-bottom: 0px;">
            <form autocomplete="off" id="w3-exerciseform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="bg-dark" style="width:750px;; padding:10px;  border-radius:10px;">
                ...
                <div class="exercisewindow" style="background-color:white; color:black; padding:10px;">
                    <h2>Output Exercise:</h2>
                    <p>Insert the missing part of the code below to output "Hello World".</p>
                    <div class="exerciseprecontainer">
                    <pre><input name="ex1" maxlength="5" style="width: 54px;"  id="text-box1" value="<?php echo $input; ?>" <?php if($xxx == 1) echo 'disabled' ?>> "Hello World";
                    </pre>
                    </div>
                    <br>
            ...
            <div class="d-flex justify-content-between" style="width:750px; margin-top:50px;">
                <button class=" btn btn-dark"type="button" onclick="window.location.href='8.php'" style="width:120px;">« Before</button>
                <button class=" btn btn-dark"type="button" onclick="window.location.href='10.php'" style="width:120px;">Next »</button>
            </div>
      </div>
    </div>
  </div>
