  ...
  <style>
    ...
    if($xxx == 1){
        ...
        if(isset($_POST['SubmitAns'])){
            ...
            $input3 = $_POST['ex3'];
            $input4 = $_POST['ex4'];
            if(($input1 == "body")&&($input2 == "{")&&($input3 == "background-color")&&($input4 == "}")){
                $output1 = "update score set soal5=1 where IDuser = '$username';";
...
<div class="page-hero-section bg-image hero-home-2" style="background-image: url(../../assets/img/bg_hero_2.svg);"  style="height:900px;">
        ...
        <div class="col-lg-6 wow fadeInUp" style="margin-bottom: 0px;">
            <form autocomplete="off" id="w3-exerciseform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="bg-dark" style="width:750px;; padding:10px;  border-radius:10px;">
                ...
                <div class="exercisewindow" style="background-color:white; color:black; padding:10px;">
                    ...
                    &lt;style&gt;
                    <br>
                    <input name="ex1" maxlength="4" style="width: 50px;" id="text-box1" value="<?php echo $input1; ?>"
                             <?php if($xxx == 1) echo 'disabled' ?>> <input name="ex2" maxlength="1" style="width: 18px;" id="text-box1" value="<?php echo $input2; ?>"
                             <?php if($xxx == 1) echo 'disabled' ?>>
                    <br>
                    &nbsp;&nbsp;<input name="ex3" spellcheck="false" maxlength="16" style="width: 166px;" id="text-box1" value="<?php echo $input3; ?>"
                             <?php if($xxx == 1) echo 'disabled' ?>>:yellow;
                    <br>
                    <input name="ex4" spellcheck="false" maxlength="1" style="width: 18px;" id="text-box1" value="<?php echo $input4; ?>"
                             <?php if($xxx == 1) echo 'disabled' ?>>
                    <br>
                    &lt;/style&gt;
                    <br>
            ...
            <div class="d-flex justify-content-between" style="width:750px; margin-top:50px;">
                <button class=" btn btn-dark"type="button" onclick="window.location.href='4.php'" style="width:120px;">« Before</button>
                <button class=" btn btn-dark"type="button" onclick="window.location.href='6.php'" style="width:120px;">Next »</button>
            </div>
      </div>
    </div>
  </div>
