  ...
  <style>
    ...
    if($xxx == 1){
        ...
        if(isset($_POST['SubmitAns'])){
            $input = $_POST['ex1'];
            if($input == "id=\"myheader\""){
                $output1 = "update score set soal8=1 where IDuser = '$username';";
        ...
        <div class="col-lg-6 wow fadeInUp" style="margin-bottom: 0px;">
            <form autocomplete="off" id="w3-exerciseform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="bg-dark" style="width:750px;; padding:10px;  border-radius:10px;">
                ...
                <div class="exercisewindow" style="background-color:white; color:black; padding:10px;">
                    <h2>Global Selector Exercise:</h2>
                    <p>Add the correct HTML attribute to make the H1 element red.</p>
                    ...
                    &lt;body&gt;
                    <br><br>
                    &lt;h1 <input name="ex1" spellcheck="false" maxlength="13" style="width: 135px;" id="text-box1" value="<?php echo $input; ?>" <?php if($xxx == 1) echo 'disabled' ?>>&gt;My Home Page&lt;/h1&gt;
                    <br><br>
                    &lt;/body&gt;
                    <br>
                    &lt;/html&gt;
            ...
            <div class="d-flex justify-content-between" style="width:750px; margin-top:50px;">
                <button class=" btn btn-dark"type="button" onclick="window.location.href='7.php'" style="width:120px;">« Before</button>
                <button class=" btn btn-dark"type="button" onclick="window.location.href='9.php'" style="width:120px;">Next »</button>
            </div>
      </div>
    </div>
  </div>
