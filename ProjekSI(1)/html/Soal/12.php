  ...
  <style>
    ...
    if($xxx == 1){
        ...
        if(isset($_POST['SubmitAns'])){
            ...
            $input2 = $_POST['ex2'];
            $input3 = $_POST['ex3'];
            if(($input1 == "if")&&($input2 == "(\$a")&&($input3 == "\$b)")){
                $output1 = "update score set soal12=1 where IDuser = '$username';";
        ...
        <div class="col-lg-6 wow fadeInUp" style="margin-bottom: 0px;">
            <form autocomplete="off" id="w3-exerciseform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="bg-dark" style="width:750px;; padding:10px;  border-radius:10px;">
                ...
                <div class="exercisewindow" style="background-color:white; color:black; padding:10px;">
                    <h2>Condition Exercise:</h2>
                    <p>Output "Hello World" if <code class="w3codespan">$a</code> is greater than <code class="w3codespan">$b</code>.</p>
                    <div class="exerciseprecontainer">
<pre>    $a = 50;
    $b = 10;
    <input name="ex1" maxlength="2" style="width: 24px;" id="text-box1" value="<?php echo $input1; ?>" <?php if($xxx == 1) echo 'disabled' ?>> <input name="ex2" maxlength="3" style="width: 32px;" id="text-box1" value="<?php echo $input2; ?>" <?php if($xxx == 1) echo 'disabled' ?>> &gt; <input name="ex3" maxlength="3" style="width: 33px;" id="text-box1" value="<?php echo $input3; ?>" <?php if($xxx == 1) echo 'disabled' ?>>{
        echo "Hello World";
    }
                    </pre>
                    </div>
            ...
            <div class="d-flex justify-content-between" style="width:750px; margin-top:50px;">
                <button class=" btn btn-dark"type="button" onclick="window.location.href='11.php'" style="width:120px;">« Before</button>
                <button class=" btn btn-dark"type="button" onclick="window.location.href='13.php'" style="width:120px;">Next »</button>
            </div>
      </div>
    </div>
  </div>
