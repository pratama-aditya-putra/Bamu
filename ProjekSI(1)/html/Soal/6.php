    ...
    if($xxx == 1){
        ...
        if(isset($_POST['SubmitAns'])){
            ...
            if(($input1 == "width")&&($input2 == "height")){
                $output1 = "update score set soal6=1 where IDuser = '$username';";
    ...
    <div class="row align-items-center h-100" style="margin-top:10%;">
        <div class="col-lg-6 wow fadeInUp" style="margin-bottom: 0px;">
            <form autocomplete="off" id="w3-exerciseform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="bg-dark" style="width:750px;; padding:10px;  border-radius:10px;">
                ...
                <h2>CSS Size Exercise:</h2>
                <p>Use the HTML image attributes to set the size of the image to 250 pixels wide and 400 pixels tall.</p>
                <div class="exerciseprecontainer">
                &lt;img src="scream.png" 
                    <input name="ex1" spellcheck="false" maxlength="5" style="width: 56px;"  id="text-box1" value="<?php echo $input1; ?>" <?php if($xxx == 1) echo 'disabled' ?>>="250" 
                    <input name="ex2" spellcheck="false" maxlength="6" style="width: 66px;"  id="text-box1" value="<?php echo $input2; ?>"
                             <?php if($xxx == 1) echo 'disabled' ?>>="400"&gt;
                </div>
                <br>
            ...
            <div class="d-flex justify-content-between" style="width:750px; margin-top:50px;">
                <button class=" btn btn-dark"type="button" onclick="window.location.href='5.php'" style="width:120px;">« Before</button>
                <button class=" btn btn-dark"type="button" onclick="window.location.href='7.php'" style="width:120px;">Next »</button>
            </div>
      </div>
    </div>
  </div>
