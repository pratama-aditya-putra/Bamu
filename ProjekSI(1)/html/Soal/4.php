  ...
  <style>
    ...
    if($xxx == 1){
        ...
        if(isset($_POST['SubmitAns'])){
            $input1 = $_POST['ex1'];
            $input2 = $_POST['ex2'];
            if(($input1 == "style")&&($input2 == "color:blue")){
                $output1 = "update score set soal4=1 where IDuser = '$username';";
        ...
        <div class="col-lg-6 wow fadeInUp" style="margin-bottom: 0px;">
            <form autocomplete="off" id="w3-exerciseform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="bg-dark" style="width:750px;; padding:10px;  border-radius:10px;">
                ...
                <div class="exercisewindow" style="background-color:white; color:black; padding:10px;">
                    <h2>Style Exercise:</h2>
                    <p>Use the correct HTML attribute, and CSS, to set the color of the paragraph to "blue".</p>
                    <div class="exerciseprecontainer">
                    &lt;p <input name="ex1" spellcheck="false" maxlength="5" style="width: 56px;"  id="text-box1" value="<?php echo $input1; ?>"
                             <?php if($xxx == 1) echo 'disabled' ?>>="<input name="ex2" spellcheck="false" maxlength="10" style="width: 106px;" id="text-box1" value="<?php echo $input2; ?>"
                             <?php if($xxx == 1) echo 'disabled' ?>>;"&gt;This is a paragraph.&lt;/p&gt;
                    </div>
                    <br>
            ...
            <div class="d-flex justify-content-between" style="width:750px; margin-top:50px;">
                <button class=" btn btn-dark"type="button" onclick="window.location.href='3.php'" style="width:120px;">« Before</button>
                <button class=" btn btn-dark"type="button" onclick="window.location.href='5.php'" style="width:120px;">Next »</button>
            </div>
      </div>
    </div>
  </div>
