  ...
  <style>
    ...
    if($xxx == 1){
        ...
        if(isset($_POST['SubmitAns'])){
            ...
            $input5 = $_POST['ex5'];
            $input6 = $_POST['ex6'];
            if((($input1 == "insert into")||($input1 == "INSERT INTO"))&&($input2 == "{")&&($input3 == "}")&&(($input4 == "VALUES")||($input4 == "values"))&&($input5 == "{")&&($input6 == "}")){
                $output1 = "update score set soal14=1 where IDuser = '$username';";
        ...
        <div class="col-lg-6 wow fadeInUp" style="margin-bottom: 0px;">
            <form autocomplete="off" id="w3-exerciseform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="bg-dark" style="width:750px;; padding:10px;  border-radius:10px;">
                ...
                <div class="exercisewindow" style="background-color:white; color:black; padding:10px;">
                    <h2>MySql Insert Exercise:</h2>
                    <p>Insert a new record in the <code class="w3-codespan">Customers</code> table.</p>
                    <div class="exerciseprecontainer">
                    <pre><input name="ex1" maxlength="11" style="width: 117px;" id="text-box1" value="<?php echo $input1; ?>" <?php if($xxx == 1) echo 'disabled' ?>> Customers <input name="ex2" maxlength="1" style="width: 15px;" id="text-box1" value="<?php echo $input2; ?>" <?php if($xxx == 1) echo 'disabled' ?>>
                    CustomerName, 
                    Address, 
                    City, 
                    PostalCode,
                    Country<input name="ex3" maxlength="1" style="width: 15px;" id="text-box1" value="<?php echo $input3; ?>" <?php if($xxx == 1) echo 'disabled' ?>>
                    <input name="ex4" maxlength="6" style="width: 64px;" id="text-box1" value="<?php echo $input4; ?>" <?php if($xxx == 1) echo 'disabled' ?>> <input name="ex5" maxlength="1" style="width: 15px;" id="text-box1" value="<?php echo $input5; ?>" <?php if($xxx == 1) echo 'disabled' ?>>
                    'Hekkan Burger',
                    'Gateveien 15',
                    'Sandnes',
                    '4306',
                    'Norway'<input name="ex6" maxlength="1" style="width: 15px;" id="text-box1" value="<?php echo $input6; ?>" <?php if($xxx == 1) echo 'disabled' ?>>;
                    </pre>
                    </div>
                    <br>
            ...
            <div class="d-flex justify-content-between" style="width:750px; margin-top:50px;">
                <button class=" btn btn-dark"type="button" onclick="window.location.href='13.php'" style="width:120px;">« Before</button>
                <button class=" btn btn-dark"type="button" onclick="window.location.href='15.php'" style="width:120px;">Next »</button>
            </div>
      </div>
    </div>
  </div>
